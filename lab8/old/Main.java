...
public class Main {
    ...
    public static void find(String[] args) {
        ...
        List match;
        Comparable findKey = null;
        if(field == "id")
            findKey = Long.parseLong(key);
        else if (field == "code")
            findKey = Integer.parseInt(key);
        else
            findKey = key;
        match = database.findIf(field, o -> o.compareTo(key) == cmp);
        printList(database.findIf(field, ));
    }
